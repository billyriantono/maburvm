...
func setupVMIPAMTestDB(t *testing.T) *gorm.DB {
	...
	for _, stmt := range []string{
		`CREATE TABLE users (id TEXT PRIMARY KEY, name TEXT NOT NULL DEFAULT '', email TEXT NOT NULL, password_hash TEXT NOT NULL, role TEXT, quota_mode TEXT NOT NULL DEFAULT 'legacy', two_factor_secret TEXT, two_factor_backup_codes TEXT, ip_whitelist TEXT, created_at DATETIME DEFAULT CURRENT_TIMESTAMP, updated_at DATETIME DEFAULT CURRENT_TIMESTAMP, token_revoked_at DATETIME, deleted_at DATETIME)`,
